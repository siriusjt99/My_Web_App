...
<script>
    function Validate() {
        ...
        var symbolRegex = /[\!\@\#\$\%\^\&\*\(\)\_\+\.\,\;\:\-]/;
        var capitalRegex = /[A-Z]/; // Regular expression for at least one capital letter
        var numberRegex = /[0-9].*[0-9]/; // Regular expression for at least two numbers
        ...
        if (User == "" && Pass == "") {
            ...
            document.getElementById("TextBox1").focus();
            return false;
        } else if (!capitalRegex.test(Pass)) { // Check if password contains at least one capital letter
            alert("Password must contain at least one capital letter.");
            document.getElementById("TextBox2").focus();
            return false;
        } else if (!numberRegex.test(Pass)) { // Check if password contains at least two numbers
